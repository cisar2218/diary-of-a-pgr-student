...
// ======== BEGIN OF SOLUTION - TASK 1-2 ======== //
  ...
  glDrawElements(GL_TRIANGLES, sizeof(unsigned short)*3*birds_data.nFaces, GL_UNSIGNED_SHORT, 0);
...
// ======== BEGIN OF SOLUTION - TASK 1-3 ======== //
  ...
  glBufferData(GL_ARRAY_BUFFER, sizeof(float)*3* birds_data.nAnimFrames * birds_data.nVertices, birds_data.vertices, GL_STATIC_DRAW);
  ...
  glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(unsigned short)*3*birds_data.nFaces, birds_data.faces, GL_STATIC_DRAW);
