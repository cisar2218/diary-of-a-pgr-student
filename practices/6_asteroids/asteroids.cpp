...
// ======== BEGIN OF SOLUTION - TASK 2_2-2 ======== //
  ...
  // speed have to be always greater or equal to zero
    gameObjects.spaceShip->speed -= deltaSpeed;
    if (gameObjects.spaceShip->speed < 0) {
        gameObjects.spaceShip->speed = 0;
    }
...
// ======== BEGIN OF SOLUTION - TASK 2_2-3 ======== //
  ...
  // update space ship direction according to the view angle
    ...
    gameObjects.spaceShip->direction.x = cos(glm::radians(gameObjects.spaceShip->viewAngle));
    gameObjects.spaceShip->direction.y = sin(glm::radians(gameObjects.spaceShip->viewAngle));
...
// ======== BEGIN OF SOLUTION - TASK 2_2-4 ======== //
  ...
  // update space ship direction according to the view angle
    gameObjects.spaceShip->viewAngle -= deltaAngle;
    if (gameObjects.spaceShip->viewAngle < 0) {
        gameObjects.spaceShip->viewAngle += 360;
    }
    gameObjects.spaceShip->direction.x = cos(glm::radians(gameObjects.spaceShip->viewAngle));
    gameObjects.spaceShip->direction.y = sin(glm::radians(gameObjects.spaceShip->viewAngle));
...
// ======== BEGIN OF SOLUTION - TASK 2_2-5 ======== //
    ...
    glm::vec3 cameraUpVector = glm::vec3(0.0f, 1.0f, 0.0f); // just up
...
// ======== BEGIN OF SOLUTION - TASK 2_2-6 ======== //
    ...
    glm::vec3 cameraCenter = gameObjects.spaceShip->position + gameObjects.spaceShip->direction;
...
// ======== BEGIN OF SOLUTION - TASK 2_2-7 ======== //
  // update space ship position taking into account timeDelta, space ship speed, and space ship direction
    gameObjects.spaceShip->position += glm::normalize(gameObjects.spaceShip->direction) * (gameObjects.spaceShip->speed * timeDelta);
