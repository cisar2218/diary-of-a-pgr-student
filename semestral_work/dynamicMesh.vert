...
void main()
{
    ...
    // copy the position and displace the y-coordinate by a sine wave
    vec3 newPos = aPos;
    newPos.y += sin(elapsedTime + newPos.x * waveFrequency) * waveHeight;

    Position_eye = (Vmatrix * Mmatrix * vec4(newPos, 1.0)).xyz;
