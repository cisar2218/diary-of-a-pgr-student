...
MeshMovTex::MeshMovTex(ShaderProgram* shdrPrg, const std::string& fileName) : ObjectInstance(shdrPrg)
{
...
MeshMovTex::MeshMovTex(ShaderProgram* shdrPrg) : ObjectInstance(shdrPrg)
{
	this->initialized = false;
