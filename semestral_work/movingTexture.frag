...
// moving texture specific uniforms START -------------------------------------
uniform vec2 scrollSpeed;
uniform float elapsedTime;
// moving texture specific uniforms END ---------------------------------------
...
void main()
{
    ...
    // specific for moving texture START ----------------------------------------
    if (texEnabled) { 
        vec2 scrollOffset = mod(scrollSpeed * elapsedTime, vec2(1.0));
        finalColor = finalColor * texture(tex, TexCoord + scrollOffset);
    }
    // specific for moving texture END ------------------------------------------
